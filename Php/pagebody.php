<div class = "body-introduction">
    <div class = "row">
            <div class = "col-lg-5 col-md-5 col-sm-5"><hr></div>
            <div class = "col-lg-2 col-md-2 col-sm-2"><h2>Yomadic</h2></div>
            <div class = "col-lg-5 col-md-5 col-sm-5"><hr></div>
    </div>
...
<div class = "recent-post">
    <div class = "row">
        ...
        <div class = "col-lg-4 col-md-4 col-sm-4"><h2>Recent travel notes</h2></div>
        <div class = "col-lg-4 col-md-4 col-sm-4"><hr></div>
    </div>
